                            ...
                            <ul>
                                <li>
                                    <span class="icon">
                                        ...
                                        <!-- <img src="../../assets/Do_Icon/Metamask_Icon_Outline.png" style="width: 30px"> -->
                                    ...
                                    <span class="text">
                                        ...
                                        <label v-show="!this.$store.state.metamaskAdd">메타마스크 로그인을 해주세요.</label>
                                    </span>
                                </li>
                                <li v-show="this.$store.state.metamaskAdd">
                                    <span class="icon">
