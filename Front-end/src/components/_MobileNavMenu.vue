        ...
        <nav class="offcanvas-navigation" id="offcanvas-navigation">
            <ul>
                <li class="menu-item-has-children">
                    <router-link to="/">설문조사</router-link>
                    <ul class="sub-menu">
                        <li>
                            <router-link to="/">전체 설문조사</router-link>
                        </li>
                        <li>
                ...
                <li class="menu-item-has-children">
                    <router-link to="/project">마이페이지</router-link>
                    <ul class="sub-menu">
                        <li>
                            <router-link to="/project">개인정보 수정</router-link>
                        </li>
                        <li>
                            <router-link to="/project-details">관심사 설정</router-link>
                        </li>
                    </ul>
                </li>
                <!-- <li class="menu-item-has-children">
